...
public class MainActivity5 extends AppCompatActivity implements ContactsAdapter.ContactsAdapterListener {
...
//            }.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, null);
        ...
        mAdapter = new ContactsAdapter(MainActivity5.this, contactList2, MainActivity5.this,currents);
...
//                  MainActivity5.this.notify();
                    ...
                    Log.i("size : ", user.getName() + " countSearchUser " + (contactList2.size() - 1) + user.getAddress());
                }
...
//            intent.putExtra("roll", "47");
    ...
    public void onContactSelected(SearchUser contact) {
        ...
        Intent intent = new Intent(MainActivity5.this, MainActivity6for7.class);
        intent.putStringArrayListExtra("key", mylist);
        intent.putExtra("Latlng", contact.getCent());
        intent.putExtra("currents", currents);
        startActivity(intent);
        //final Context context = this;
        //Intent intent = new Intent(context, DetailActivity.class);
